...
<div class="emailQueues index">
    ...
    <tr>
            ...
            <th>
                <?php echo $this->Paginator->sort('subject'); ?><br/>
    ...
    <tr>
        ...
        <td>
            <?php echo h($emailQueue['EmailQueue']['subject']); ?><br/>
            (<?php echo h($emailQueue['EmailQueue']['template']); ?>, <?php echo h($emailQueue['EmailQueue']['format']); ?>)
        </td>
